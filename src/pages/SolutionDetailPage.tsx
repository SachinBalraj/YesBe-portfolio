    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white to-[#f8fbff] py-12 lg:py-16">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp}>
              <SectionHeading icon={Target}>What This Solution Is</SectionHeading>
              <p className="text-[15px] leading-relaxed text-muted-foreground">
                {solution.overview}
              </p>
            </motion.div>
            <motion.div variants={fadeInUp}>
              <SectionHeading icon={Lightbulb}>Why Businesses Need It</SectionHeading>
              <p className="text-[15px] leading-relaxed text-muted-foreground">
                {solution.whyNeeded}
              </p>
            </motion.div>
          ...
          <motion.div
            ...
            className="mt-10"
          >
            <SectionHeading icon={Target}>Business Challenges We Solve</SectionHeading>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white to-[#f8fbff] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-8"
          >
            <SectionHeading icon={Layers}>Technologies Used</SectionHeading>
          </motion.div>
          <motion.div
            variants={staggerContainer}
            initial="initial"
          ...
          >
            ...
            <div className="rounded-[20px] border border-white/40 bg-white p-6 sm:p-8" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.04), 0 4px 16px rgba(37,99,235,0.03)" }}>
              ...
              <div className="inline-flex items-center gap-2 rounded-full bg-primary/[0.06] px-4 py-2">
                ...
                <span className="text-[14px] font-semibold text-primary">{solution.caseStudy.metric}</span>
              </div>
              <div className="mt-5">
                <Link
                  to="/case-studies"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-[15px] text-white/80 max-w-xl mx-auto mb-6">
              Let's discuss your goals and create a tailored solution that drives real results.
            </p>
